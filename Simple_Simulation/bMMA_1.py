...
file_path = 'exam_json/big_base_nodec_nokc_1.json'
traj_dir_name = "result/bMMA1"
...
# recalc all params
from MMA_AIBN_param import get_ki, get_density, get_kp_, get_kp, get_kit
from MMA_AIBN_param import get_kp_, get_ktc, get_ktd, get_kfm, get_f, get_Mw
T0 = 273.15
T = T0 + config['T']
